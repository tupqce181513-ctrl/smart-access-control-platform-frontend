...
import { Lock, Sun, Moon, Home } from 'lucide-react';
...
function LoginPage() {
  ...
  return (
    <div className={`relative flex min-h-screen items-center justify-center bg-linear-to-br ${isDark ? 'from-gray-900 via-blue-900 to-purple-900' : 'from-blue-50 via-indigo-50 to-purple-50'} px-4 py-8 overflow-hidden ${isDark ? 'dark' : ''}`}>
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        <div className="rounded-2xl border border-white/20 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl p-8 shadow-2xl">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">Sign in to continue</p>
          </div>

          {/* Gradient divider */}
          <div className="mb-6 h-1 w-full bg-linear-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-full opacity-50"></div>
